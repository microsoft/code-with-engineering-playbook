...
> Please refer to <http://github.com/microsoft/code-with-engineering-playbook/design-reviews/recipes/milestone-epic-design-review-recipe.md> for things to keep in mind when using this template.
