...
4. [Azure Monitor Workbooks](https://docs.microsoft.com/en-us/azure/azure-monitor/platform/workbooks-overview) - Visualizations for your logged data, tightly interated with Azure services and higly customizable.
...
4. Is my system health for the past one day/week/month/quarter?
