...
We should always aim to have Pull Requests as smaller as possible, without losing context and technical feasibility. Small pull requests have multiple benefits:
