...
**What it is not**: This document is not a checklist for how customers or readers should handle data in their environment, and does not override InfoMagnus's or the customers' policies for data handling, data protection and information security.
