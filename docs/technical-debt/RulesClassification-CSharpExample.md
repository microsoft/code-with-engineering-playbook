...
- Tools to automate detection of quality improvements opportunities:
  - NETAnalyzers - Fxcop (.NET Analyzers): https://docs.microsoft.com/en-us/dotnet/fundamentals/code-analysis/quality-rules/
  - NETAnalyzers - StyleCop: https://docs.microsoft.com/en-us/dotnet/fundamentals/code-analysis/style-rules/
...
| Are there appropriate negative tests written?                                           | N        | Y    | Negative tests validate wrong inputs and check if they are handled correctly                                                                                                                                                               | https://en.wikipedia.org/wiki/Negative_testing                                                                                   |
...
Following the recommendations of using StyleCop per: playbook.
This model allows for suppressions and their justification in the code, providing reviewers the ability to reason about suppressions and whether they are appropriate.
