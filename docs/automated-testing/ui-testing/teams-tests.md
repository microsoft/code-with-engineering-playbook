...
If you would like to test a Teams app that is not yet published into the Teams' store, or if you would like to test the DEV/QA version of your app you can use the [Teams Toolkit](https://github.com/OfficeDev/TeamsFx) and package your app based on the [manifest.json](https://learn.microsoft.com/en-us/microsoftteams/platform/resources/schema/manifest-schema)
...
When running test, you need to use the Selenium server URL for remote execution. With the definition from above, the URL is: [http://selenium:4444/wd/hub](http://selenium:4444/wd/hub).
...
### Using Android Virtual Devices (AVD)
...
1. Install the UiAutomator2 driver: [Install the UiAutomator2 Driver - Appium Documentation](https://appium.io/docs/en/2.0/quickstart/uiauto2-driver/). Go through the `Set up Android automation requirements` in the documentation, to make sure you have set up everything correctly.
    ...
    > [Read more about Appium Drivers here](https://appium.io/docs/en/2.0/intro/drivers/)
